...
/*
  if (controlla_tutto(s)==0)
    printf("il sudoku è sbagliato, hai ragione");
  else
    printf("c'è qualcosa che non va");
  if (quadro_giusto2(s,2,2)==1)
    printf("il quadrato 0,1 è giusto");
  else
    printf("il quadrato 0,1 è sbagliato");
  if (riga_giusta(s,0)==1)
    printf("esatto la riga 0 è giusta\n");
    else 
      printf("c'è qualcosa che non va\n");
  if (riga_giusta(s,1)==0)
    printf("esatto la riga 1 è sbagliata\n");
  else
      printf("c'è qualcosa che non va\n");
  if (colonna_giusta(s,0)==0)
    printf("esatto la colonna 0 è sbagliata\n");
  else
      printf("c'è qualcosa che non va\n");
  if (colonna_giusta(s,1)==0)
    printf("esatto la colonna 1 è sbagliata\n");
  else
      printf("c'è qualcosa che non va\n");

  if (quadro_giusto2(s,0,0)==1)
    printf("esatto il quadro 1 è giusto\n");
  else
      printf("c'è qualcosa che non va\n");

  if (quadro_giusto2(s,1,0)==0)
    printf("esatto il quadro 3 è sbagliato\n");
  else 
      printf("c'è qualcosa che non va\n");
return 0;
*/
